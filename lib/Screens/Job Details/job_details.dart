              ...
              onTap: ()async{
                ...
                if(response.statusCode == 409){
                  Get.defaultDialog(
                      ...
                      content: Column(
                        children: [
                          Text("You already applied to this job",style:TextStyle(
                              fontSize: 12,
                              fontFamily: 'OpenSans-Bold',
                              color: flyBlack2
                          ),),
                  ...
                  Get.defaultDialog(
                      ...
                      content: Column(
                        children: [
                          Text("Your job is applied and will show in Myjobs",style:TextStyle(
                              fontSize: 12,
                              fontFamily: 'OpenSans-Bold',
                              color: flyBlack2
                          ),),
                          Center(
                            child:Text("after admin's confirmation",style:TextStyle(
                                fontSize: 12,
                                fontFamily: 'OpenSans-Bold',
                                color: flyBlack2
                            ),),
