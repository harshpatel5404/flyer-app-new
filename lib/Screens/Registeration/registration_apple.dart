...
class AppleSignInRegistration extends StatefulWidget {
  const AppleSignInRegistration({Key? key}) : super(key: key);

  @override
  State<AppleSignInRegistration> createState() => _AppleSignInRegistrationState();
}

class _AppleSignInRegistrationState extends State<AppleSignInRegistration> {
